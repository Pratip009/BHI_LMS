                    ...
                    <>
                        ...
                        <div className="w-[95%] 800px:w-[85%] m-auto min-h-[70vh]">
                            <Heading
                                ...
                                description={'ELearning is a education platform'}
                                keywords={'Programming community'}
                            />
                            <br />
                            <div className="w-full flex items-center flex-wrap">
                                <div className={`h-[35px] ${category === 'All' ? 'bg-[crimson]' : 'bg-[#5050cb]'} m-3 px-3 rounded-[30px] flex items-center justify-center font-Poppins cursor-pointer`}
                                ...
                                </div>
                                {
                                    categories && categories.map((item: any, index: number) => (
                                        <div className="" key={index}>
                                            <div className={`h-[35px] ${category === item.title ? 'bg-[crimson]' : 'bg-[#5050cb]'} m-3 px-3 rounded-[30px] flex items-center justify-center font-Poppins cursor-pointer`}
