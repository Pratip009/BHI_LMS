                ...
                <div className="w-[95%] 800px:w-full 800px:max-w-[85%] mx-auto px-2 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4">
                        ...
                        <div className="space-y-3">
                            ...
                            <ul className="space-y-4">
                                <li>
                                    <Link href="https://www.youtube.com/" className="text-base text-black dark:text-gray-300 dark:hover:text-white">
                                        Youtube
                                    </Link>
                                </li>
                                <li>
                                    <Link href="https://www.linkedin.com/feed/" className="text-base text-black dark:text-gray-300 dark:hover:text-white">
                                        LinkedIn
                                    </Link>
                                </li>
                                <li>
                        ...
                        <div>
                            <h3 className='text-[20px] font-[600] text-black dark:text-white pb-3'>Conact Info</h3>
                            <p className='text-base text-black dark:text-gray-300 dark:hover:text-white pb-2'>Call Us: +1 (551) 804-3663</p>
                            <p className='text-base text-black dark:text-gray-300 dark:hover:text-white pb-2'>Address:591 Summit Ave Suite No. 400, Jersey City, NJ 07306, United States</p>

                            <p className='text-base text-black dark:text-gray-300 dark:hover:text-white pb-2'>Mail Us: training@brighthorizoninstitute.com</p>
