                    ...
                    <Box m="20px">
                        <Box
                            ...
                            sx={{
                                ...
                                "& .MuiDataGrid-virtualScroller": {
                                    backgroundColor: theme === "dark" ? "#1F1A40" : "#F2F0F0",
                                },
                        ...
                        </Box>
                        {
                            open && (
                                ...
                                >
                                    <Box className="absolute top-1/2 left-1/2 translate-x-[-50%] translate-y-[-50%] bg-white dark:bg-[#1F1A40] p-5 rounded-lg shadow-lg w-[400px]">
                                        ...
                                        <div className="flex w-full items-center justify-between mb-6 mt-2 ">
                                            <button
                                                className={`${styles.button} !w-[150px] dark:bg-[#57c7a3] !h-[35px] dark:border dark:border-[#ffffff6c]`}
                                                onClick={() => setOpen(!open)}
                                            >
                                                Cancel
                                            </button>
                                            <button
                                                className={`${styles.button} !w-[150px] bg-red-500 !h-[35px] dark:border dark:border-[#ffffff6c]`}
