    ...
    return (
        <div className='w-[80%] m-auto mt-24 p-3'>
            <form onSubmit={handleSubmit}>
                                        ...
                                        !isCollapsed[index] && (
                                            <>
                                                ...
                                                <div className="inline-block mb-4">
                                                    <p className='flex items-center text-[18px] text-black dark:text-white cursor-pointer'
                ...
                <br />
                <div className="flex items-center text-[20px] text-black dark:text-white cursor-pointer "
