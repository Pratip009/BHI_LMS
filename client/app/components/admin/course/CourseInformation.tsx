      ...
      <form onSubmit={handleSubmit}>
        <div>
          ...
          <input
            ...
            id='name'
            placeholder='MERN stack, Full stack course'
        ...
        <div className='w-full flex justify-between'>
          <div className="w-[45%]">
            ...
            <input
              ...
              id='tags'
              placeholder='MERN , Nextjs , Tailwind , React'
              className={`${styles.input}`}
            />
          </div>
          <div className="w-[50%]">
            ...
            <select name="" id="" value={courseInfo.categories?.id || ""}
              className={`${styles.input} dark:bg-black dark:text-white bg-white text-black`}
              onChange={(e: any) => {
            ...
            >
              ...
              {categories.map((item: any) => (
                <option value={item._id} key={item._id} className="dark:bg-gray-800 dark:text-white bg-white text-black">
                  {item.title}
                </option>
              ))}
            </select>
          ...
          >
            {
              courseInfo.thumbnail ? (
                ...
                <span className='text-black dark:text-white'>Drag and drop your thumbnail or click to browse</span>
              )
            }
          </label>
        </div>
