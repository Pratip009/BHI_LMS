...
const ReviewCard = (props: Props) => {
    return (
        <div className='w-full h-max pb-4 dark:bg-slate-500 dark:bg-opacity-[0.20] border border-[#00000028] dark:border-[#ffffff1d] backdrop-blur shadow-[bg-slate-500] rounded-lg p-3 shadow-inner'>
            ...
            <p className='pt-2 px-2 font-Poppins text-black dark:text-white'>{props.item.comment}</p>
        </div>
    )
}
